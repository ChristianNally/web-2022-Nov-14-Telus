...
Jest is a fully fledged testing framework, built by Facebook. No accident that it gets shipped with 
create-react-app.


# What is it about Mocha that knows your test failed?

# What are you we going to test today? Introducing Moai / Axe / Tree
